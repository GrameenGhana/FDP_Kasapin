...
@section('Title', __('labels.backend.survey.forms.management') .' | '.__('labels.backend.survey.forms.edit'))

@section('content')
    {{ html()->modelForm($form, 'PATCH', route('admin.survey.form.update', $form))->class('form-horizontal')->open() }}
            ...
            <div class="row">
                <div class="col-sm-5">
                    <h4 class="card-title mb-0">
                        ...
                        <small class="text-muted">@lang('labels.backend.survey.forms.edit')</small>
                    </h4>
                </div><!--col-->
            </div><!--row-->
