...
@section('Title', __('labels.backend.survey.forms.questions.management') .' | '.__('labels.backend.survey.forms.questions.edit'))

@section('content')
    {{ html()->modelForm($question, 'PATCH', route('admin.survey.form.question.update', $question))->class('form-horizontal')->open() }}
            ...
            <div class="row">
                <div class="col-sm-5">
                    <h4 class="card-title mb-0">
                        ...
                        <small class="text-muted">@lang('labels.backend.survey.forms.edit_question')</small>
                    </h4>
                </div><!--col-->
            </div><!--row-->
